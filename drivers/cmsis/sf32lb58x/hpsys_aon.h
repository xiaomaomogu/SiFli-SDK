...
#define HPSYS_AON_CR2_PIN16_MODE_Pos    (24U)
#define HPSYS_AON_CR2_PIN16_MODE_Msk    (0x7UL << HPSYS_AON_CR2_PIN16_MODE_Pos)
#define HPSYS_AON_CR2_PIN16_MODE        HPSYS_AON_CR2_PIN16_MODE_Msk
#define HPSYS_AON_CR2_PIN17_MODE_Pos    (27U)
#define HPSYS_AON_CR2_PIN17_MODE_Msk    (0x7UL << HPSYS_AON_CR2_PIN17_MODE_Pos)
#define HPSYS_AON_CR2_PIN17_MODE        HPSYS_AON_CR2_PIN17_MODE_Msk
...
#define HPSYS_AON_WSR_PIN_ALL           (HPSYS_AON_WSR_PIN0 | HPSYS_AON_WSR_PIN1 | HPSYS_AON_WSR_PIN2 | HPSYS_AON_WSR_PIN3      \
                                         ...
                                         | HPSYS_AON_WSR_PIN16 | HPSYS_AON_WSR_PIN17)

#define HPSYS_AON_WSR_PIN_NUM           (18)

#define HPSYS_AON_WSR_PBR_PIN_FIRST     (HPSYS_AON_WSR_PIN12_Pos)
#define HPSYS_AON_WSR_PBR_PIN_ALL       (HPSYS_AON_WSR_PIN12 | HPSYS_AON_WSR_PIN13| HPSYS_AON_WSR_PIN14 | HPSYS_AON_WSR_PIN15 \
                                         | HPSYS_AON_WSR_PIN16 | HPSYS_AON_WSR_PIN17)
#define HPSYS_AON_WSR_PBR_PIN_NUM       (6)
