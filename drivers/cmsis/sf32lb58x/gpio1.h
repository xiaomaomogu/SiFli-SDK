...
typedef struct
{
    ...
    __IO uint32_t ISR2;
    __IO uint32_t IER2_EXT;
    __IO uint32_t IESR2_EXT;
    __IO uint32_t IECR2_EXT;
    __IO uint32_t ISR2_EXT;
    __IO uint32_t OEMR2;
...
#define GPIO1_DOSR2_DOS_Msk             (0xFFFFFFFFUL << GPIO1_DOSR2_DOS_Pos)
#define GPIO1_DOSR2_DOS                 GPIO1_DOSR2_DOS_Msk

/****************** Bit definition for GPIO1_DOCR2 register *******************/
#define GPIO1_DOCR2_DOC_Pos             (0U)
#define GPIO1_DOCR2_DOC_Msk             (0xFFFFFFFFUL << GPIO1_DOCR2_DOC_Pos)
...
#define GPIO1_DOESR2_DOES_Msk           (0xFFFFFFFFUL << GPIO1_DOESR2_DOES_Pos)
#define GPIO1_DOESR2_DOES               GPIO1_DOESR2_DOES_Msk

/****************** Bit definition for GPIO1_DOECR2 register ******************/
#define GPIO1_DOECR2_DOEC_Pos           (0U)
#define GPIO1_DOECR2_DOEC_Msk           (0xFFFFFFFFUL << GPIO1_DOECR2_DOEC_Pos)
...
/***************** Bit definition for GPIO1_IER2_EXT register *****************/
#define GPIO1_IER2_EXT_IER_Pos          (0U)
#define GPIO1_IER2_EXT_IER_Msk          (0xFFFFFFFFUL << GPIO1_IER2_EXT_IER_Pos)
#define GPIO1_IER2_EXT_IER              GPIO1_IER2_EXT_IER_Msk

/**************** Bit definition for GPIO1_IESR2_EXT register *****************/
#define GPIO1_IESR2_EXT_IES_Pos         (0U)
#define GPIO1_IESR2_EXT_IES_Msk         (0xFFFFFFFFUL << GPIO1_IESR2_EXT_IES_Pos)
#define GPIO1_IESR2_EXT_IES             GPIO1_IESR2_EXT_IES_Msk

/**************** Bit definition for GPIO1_IECR2_EXT register *****************/
#define GPIO1_IECR2_EXT_IEC_Pos         (0U)
#define GPIO1_IECR2_EXT_IEC_Msk         (0xFFFFFFFFUL << GPIO1_IECR2_EXT_IEC_Pos)
#define GPIO1_IECR2_EXT_IEC             GPIO1_IECR2_EXT_IEC_Msk

/***************** Bit definition for GPIO1_ISR2_EXT register *****************/
#define GPIO1_ISR2_EXT_IS_Pos           (0U)
#define GPIO1_ISR2_EXT_IS_Msk           (0xFFFFFFFFUL << GPIO1_ISR2_EXT_IS_Pos)
#define GPIO1_ISR2_EXT_IS               GPIO1_ISR2_EXT_IS_Msk

/****************** Bit definition for GPIO1_OEMR2 register *******************/
#define GPIO1_OEMR2_OEM_Pos             (0U)
#define GPIO1_OEMR2_OEM_Msk             (0xFFFFFFFFUL << GPIO1_OEMR2_OEM_Pos)
#define GPIO1_OEMR2_OEM                 GPIO1_OEMR2_OEM_Msk

/****************** Bit definition for GPIO1_OEMSR2 register ******************/
#define GPIO1_OEMSR2_OEMS_Pos           (0U)
#define GPIO1_OEMSR2_OEMS_Msk           (0xFFFFFFFFUL << GPIO1_OEMSR2_OEMS_Pos)
#define GPIO1_OEMSR2_OEMS               GPIO1_OEMSR2_OEMS_Msk

/****************** Bit definition for GPIO1_OEMCR2 register ******************/
#define GPIO1_OEMCR2_OEMC_Pos           (0U)
#define GPIO1_OEMCR2_OEMC_Msk           (0xFFFFFFFFUL << GPIO1_OEMCR2_OEMC_Pos)
