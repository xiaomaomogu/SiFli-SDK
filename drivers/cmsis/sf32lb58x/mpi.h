...
#define MPI_MISCR_DQSDLYU_Pos           (17U)
#define MPI_MISCR_DQSDLYU_Msk           (0xFUL << MPI_MISCR_DQSDLYU_Pos)
#define MPI_MISCR_DQSDLYU               MPI_MISCR_DQSDLYU_Msk
#define MPI_MISCR_SCKDLYU_Pos           (21U)
#define MPI_MISCR_SCKDLYU_Msk           (0xFUL << MPI_MISCR_SCKDLYU_Pos)
#define MPI_MISCR_SCKDLYU               MPI_MISCR_SCKDLYU_Msk
...
#define MPI_WDTR_TIMEOUT_Msk            (0xFFFUL << MPI_WDTR_TIMEOUT_Pos)
