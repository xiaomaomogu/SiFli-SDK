...
/******************* Bit definition for SDMMC_NSAR register *******************/
#define SDMMC_NSAR_ADDR_Pos             (0U)
#define SDMMC_NSAR_ADDR_Msk             (0xFFFFFFFFUL << SDMMC_NSAR_ADDR_Pos)
#define SDMMC_NSAR_ADDR                 SDMMC_NSAR_ADDR_Msk
...
/******************* Bit definition for SDMMC_SCR register ********************/
#define SDMMC_SCR_DLY_Pos               (0U)
#define SDMMC_SCR_DLY_Msk               (0x3FUL << SDMMC_SCR_DLY_Pos)
#define SDMMC_SCR_DLY                   SDMMC_SCR_DLY_Msk
#define SDMMC_SCR_SEL_Pos               (31U)
#define SDMMC_SCR_SEL_Msk               (0x1UL << SDMMC_SCR_SEL_Pos)
#define SDMMC_SCR_SEL                   SDMMC_SCR_SEL_Msk
