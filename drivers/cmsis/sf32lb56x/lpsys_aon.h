...
#define LPSYS_AON_SBCR_PD_ITCM_Pos      (9U)
...
#define LPSYS_AON_SBCR_PD_DTCM_Pos      (10U)
...
#define LPSYS_AON_WSR_PIN_ALL           (LPSYS_AON_WSR_PIN0 | LPSYS_AON_WSR_PIN1 | LPSYS_AON_WSR_PIN2      \
                                         ...
                                         | LPSYS_AON_WSR_PIN12 | LPSYS_AON_WSR_PIN13)
#define LPSYS_AON_WSR_PIN_NUM           (14)

#define LPSYS_AON_WSR_PBR_PIN_FIRST     (LPSYS_AON_WSR_PIN10_Pos)
#define LPSYS_AON_WSR_PBR_PIN_ALL       (LPSYS_AON_WSR_PIN10 | LPSYS_AON_WSR_PIN11  \
                                         | LPSYS_AON_WSR_PIN12 | LPSYS_AON_WSR_PIN13)
#define LPSYS_AON_WSR_PBR_PIN_NUM       (4)
