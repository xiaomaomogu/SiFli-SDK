 ...
 */
__ROM_USED rt_err_t rt_device_register(rt_device_t dev,
                                       const char *name,
                                       rt_uint16_t flags)
{
    if (dev == RT_NULL)
 ...
 */
__ROM_USED rt_err_t rt_device_unregister(rt_device_t dev)
{
 ...
 */
__ROM_USED rt_err_t rt_device_init_all(void)
{
    return RT_EOK;
}
 ...
 */
__ROM_USED rt_device_t rt_device_create(int type, int attach_size)
{
    int size;
    rt_device_t device;
 ...
 */
__ROM_USED void rt_device_destroy(rt_device_t dev)
{
    RT_ASSERT(dev != RT_NULL);
    RT_ASSERT(rt_object_get_type(&dev->parent) == RT_Object_Class_Device);
 ...
 * @return the result
 */
__ROM_USED rt_err_t rt_device_init(rt_device_t dev)
{
 ...
 * @return the result
 */
__ROM_USED rt_err_t rt_device_open(rt_device_t dev, rt_uint16_t oflag)
{
    rt_err_t result = RT_EOK;
 ...
 * @return the result
 */
__ROM_USED rt_err_t rt_device_close(rt_device_t dev)
{
    rt_err_t result = RT_EOK;
 ...
 */
__ROM_USED rt_size_t rt_device_read(rt_device_t dev,
                                    rt_off_t    pos,
                                    void       *buffer,
                                    rt_size_t   size)
{
 ...
 * @note since 0.4.0, the unit of size/pos is a block for block device.
 */
__ROM_USED rt_size_t rt_device_write(rt_device_t dev,
                                     rt_off_t    pos,
                                     const void *buffer,
                                     rt_size_t   size)
{
 ...
 * @return the result
 */
__ROM_USED rt_err_t rt_device_control(rt_device_t dev, int cmd, void *arg)
{
    RT_ASSERT(dev != RT_NULL);
    RT_ASSERT(rt_object_get_type(&dev->parent) == RT_Object_Class_Device);
