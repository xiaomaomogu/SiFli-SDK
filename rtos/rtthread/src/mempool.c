 ...
 */
__ROM_USED void rt_mp_alloc_sethook(void (*hook)(struct rt_mempool *mp, void *block))
{
 ...
 * @param hook the hook function
 */
__ROM_USED void rt_mp_free_sethook(void (*hook)(struct rt_mempool *mp, void *block))
{
 ...
 * @return RT_EOK
 */
__ROM_USED rt_err_t rt_mp_init(struct rt_mempool *mp,
                               const char        *name,
                               void              *start,
                               rt_size_t          size,
 ...
 * @return RT_EOK
 */
__ROM_USED rt_err_t rt_mp_detach(struct rt_mempool *mp)
{
 ...
 */
__ROM_USED rt_mp_t rt_mp_create(const char *name,
 ...
 * @return RT_EOK
 */
__ROM_USED rt_err_t rt_mp_delete(rt_mp_t mp)
{
    struct rt_thread *thread;
    register rt_ubase_t temp;
 ...
 */
__ROM_USED void *rt_mp_alloc(rt_mp_t mp, rt_int32_t time)
{
    rt_uint8_t *block_ptr;
 ...
 */
__ROM_USED void rt_mp_free(void *block)
{
    rt_uint8_t **block_ptr;
    struct rt_mempool *mp;
    struct rt_thread *thread;
