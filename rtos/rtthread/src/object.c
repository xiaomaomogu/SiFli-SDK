...
enum rt_object_info_type
{
    ...
    RT_Object_Info_Audio,                              /**< The object is an Audio Process module. */
#endif
...
__ROM_USED void (*rt_object_trytake_hook)(struct rt_object *object);
__ROM_USED void (*rt_object_take_hook)(struct rt_object *object);
__ROM_USED void (*rt_object_put_hook)(struct rt_object *object);
 ...
 */
__ROM_USED void rt_object_attach_sethook(void (*hook)(struct rt_object *object))
{
 ...
 * @param hook the hook function
 */
__ROM_USED void rt_object_detach_sethook(void (*hook)(struct rt_object *object))
{
 ...
 * @param hook the hook function
 */
__ROM_USED void rt_object_trytake_sethook(void (*hook)(struct rt_object *object))
{
 ...
 * @param hook the hook function
 */
__ROM_USED void rt_object_take_sethook(void (*hook)(struct rt_object *object))
{
 ...
 * @param hook the hook function
 */
__ROM_USED void rt_object_put_sethook(void (*hook)(struct rt_object *object))
{
 ...
 */
__ROM_USED void rt_system_object_init(void)
{
}
 ...
 */
__ROM_USED struct rt_object_information *
 ...
 */
__ROM_USED void rt_object_init(struct rt_object         *object,
 ...
 */
__ROM_USED void rt_object_detach(rt_object_t object)
{
    register rt_base_t temp;
 ...
 */
__ROM_USED void rt_object_delete(rt_object_t object)
{
    register rt_base_t temp;
 ...
 */
__ROM_USED rt_bool_t rt_object_is_systemobject(rt_object_t object)
{
    /* object check */
    RT_ASSERT(object != RT_NULL);
 ...
 */
__ROM_USED rt_uint8_t rt_object_get_type(rt_object_t object)
{
    /* object check */
    RT_ASSERT(object != RT_NULL);
 ...
 */
__ROM_USED rt_object_t rt_object_find(const char *name, rt_uint8_t type)
{
