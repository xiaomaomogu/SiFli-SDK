...
__ROM_USED union finsh_value  *finsh_compile_sp;       /* stack pointer */
__ROM_USED uint8_t            *finsh_compile_pc;       /* PC */
...
__ROM_USED int finsh_compiler_run(struct finsh_node *node)
{
    struct finsh_node *sibling;
