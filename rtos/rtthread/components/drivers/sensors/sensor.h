...
#if defined(RT_USING_RTC)&&!defined(WIN32)
...
#define RT_SENSOR_CLASS_GPS            (14) /* GPS sensor      */
...
#define RT_SENSOR_VENDOR_AMS           (7)  /* AMS */
...
#define  RT_SENSOR_UNIT_DEG            (14) /* GPS                     unit: degree     */
...
#define  RT_SENSOR_CTRL_GET_ID         (0x20 + 0)  /* Get device id */
#define  RT_SENSOR_CTRL_GET_INFO       (0x20 + 1)  /* Get sensor info */
#define  RT_SENSOR_CTRL_SET_RANGE      (0x20 + 2)  /* Set the measure range of sensor. unit is info of sensor */
#define  RT_SENSOR_CTRL_SET_ODR        (0x20 + 3)  /* Set output date rate. unit is HZ */
#define  RT_SENSOR_CTRL_SET_MODE       (0x20 + 4)  /* Set sensor's work mode. ex. RT_SENSOR_MODE_POLLING,RT_SENSOR_MODE_INT */
#define  RT_SENSOR_CTRL_SET_POWER      (0x20 + 5)  /* Set power mode. args type of sensor power mode. ex. RT_SENSOR_POWER_DOWN,RT_SENSOR_POWER_NORMAL */
#define  RT_SENSOR_CTRL_SELF_TEST      (0x20 + 6)  /* Take a self test */
...
struct rt_sensor_data
{
    ...
    union
    {
        ...
        struct sensor_gps_loc gps;          /* gps sensor.          unit: degree      */
    } data;
};
