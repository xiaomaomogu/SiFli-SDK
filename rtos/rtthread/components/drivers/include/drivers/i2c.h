...
struct rt_i2c_bus_device_ops
{
    ...
    rt_err_t (*i2c_bus_control)(struct rt_i2c_bus_device *bus,
                                rt_uint32_t cmd,
                                void *arg);
    rt_err_t (*i2c_bus_configure)(struct rt_i2c_bus_device *bus,
...
rt_err_t rt_i2c_close(struct rt_i2c_bus_device *dev);
rt_err_t rt_i2c_control(struct rt_i2c_bus_device *dev,  int cmd, void  *args);
