...
__ROM_USED void rt_wqueue_add(rt_wqueue_t *queue, struct rt_wqueue_node *node)
{
    rt_base_t level;
...
__ROM_USED void rt_wqueue_remove(struct rt_wqueue_node *node)
{
    rt_base_t level;
...
__ROM_USED int __wqueue_default_wake(struct rt_wqueue_node *wait, void *key)
{
    return 0;
}

__ROM_USED void rt_wqueue_wakeup(rt_wqueue_t *queue, void *key)
{
    rt_base_t level;
...
__ROM_USED int rt_wqueue_wait(rt_wqueue_t *queue, int condition, int msec)
{
    int tick;
