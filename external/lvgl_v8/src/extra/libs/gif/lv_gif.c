...
void lv_gif_set_src(lv_obj_t * obj, const void * src)
{
    ...
    gifobj->imgdsc.data_size=gifobj->imgdsc.header.h*gifobj->imgdsc.header.w*LV_IMG_PX_SIZE_ALPHA_BYTE;
...
void lv_gif_resume(lv_obj_t * obj)
{
    ...
    if (gifobj->timer==NULL)
        gifobj->timer=lv_timer_create(next_frame_task_cb, 100, obj);
