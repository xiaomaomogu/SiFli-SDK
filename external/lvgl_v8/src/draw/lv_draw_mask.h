...
/**
 * @brief Get map mask parameters and return true if there is only 1 map mask present. 
 * @param a - an area to test for affecting masks.
 * @param p - returned parameter of map mask
 * @return true if there is only 1 map mask present, else false.
 */
