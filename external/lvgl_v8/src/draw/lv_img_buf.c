...
lv_color_t lv_img_buf_get_px_color(lv_img_dsc_t * dsc, lv_coord_t x, lv_coord_t y, lv_color_t color)
{
    ...
    if(dsc->header.cf == LV_IMG_CF_TRUE_COLOR || dsc->header.cf == LV_IMG_CF_TRUE_COLOR_CHROMA_KEYED ||
       dsc->header.cf == LV_IMG_CF_TRUE_COLOR_ALPHA || dsc->header.cf == LV_IMG_CF_RGB565A8) {
        ...
        p_color.ch.blue = (buf_u8[px] & (1 << (7 - bit))) >> (7 - bit);
#else        
...
#if LV_COLOR_DEPTH == 24    
        p_color.ch.blue = (buf_u8[px] & (3 << (6 - bit))) >> (6 - bit);
#else        
...
#if LV_COLOR_DEPTH == 24  
        p_color.ch.blue = (buf_u8[px] & (0xF << (4 - bit))) >> (4 - bit);
#else        
...
void lv_img_buf_set_px_color(lv_img_dsc_t * dsc, lv_coord_t x, lv_coord_t y, lv_color_t c)
{
    ...
    if(dsc->header.cf == LV_IMG_CF_TRUE_COLOR || dsc->header.cf == LV_IMG_CF_TRUE_COLOR_CHROMA_KEYED) {
        ...
        buf_u8[px]  = buf_u8[px] & ~(1 << (7 - bit));
#if LV_COLOR_DEPTH == 24
		buf_u8[px] = buf_u8[px] | ((c.ch.blue & 0x1) << (7 - bit));
#else
        ...
        buf_u8[px] = buf_u8[px] & ~(3 << (6 - bit));
#if LV_COLOR_DEPTH == 24
		buf_u8[px] = buf_u8[px] | ((c.ch.blue & 0x3) << (6 - bit));
#else  
        ...
        buf_u8[px]  = buf_u8[px] & ~(0xF << (4 - bit));
#if LV_COLOR_DEPTH == 24
		buf_u8[px] = buf_u8[px] | ((c.ch.blue & 0xF) << (4 - bit));
#else
