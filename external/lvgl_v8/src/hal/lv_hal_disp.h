...
typedef struct _lv_disp_draw_buf_t {
    ...
    uint8_t cf;       /**< color format, such as #LV_IMG_CF_TRUE_COLOR_ALPHA */
...
void set_px_true_color_alpha(lv_disp_drv_t * disp_drv, uint8_t * buf, lv_coord_t buf_w, lv_coord_t x,
                                    lv_coord_t y,
                                    lv_color_t color, lv_opa_t opa);

void set_px_cb_rgb565(lv_disp_drv_t * disp_drv, uint8_t * buf, lv_coord_t buf_w, lv_coord_t x,
                                    lv_coord_t y,
                                    lv_color_t color, lv_opa_t opa);
/**********************
 *      MACROS
