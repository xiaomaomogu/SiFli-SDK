...
{
    lv_theme_t * th = lv_theme_get_from_obj(obj);
	if (th&&th->font_normal)
		return th->font_normal;
	else
		return LV_FONT_DEFAULT;
}
...
const lv_font_t * lv_theme_get_font_large(lv_obj_t * obj)
{
    lv_theme_t * th = lv_theme_get_from_obj(obj);
	if (th&&th->font_large)
		return th->font_large;
	else
		return LV_FONT_DEFAULT;
}

const lv_font_t * lv_theme_get_font_subtitle(lv_obj_t * obj)
{
    lv_theme_t * th = lv_theme_get_from_obj(obj);
	if (th&&th->font_subtitle)
		return th->font_subtitle;
	else
		return LV_FONT_DEFAULT;
}

const lv_font_t * lv_theme_get_font_title(lv_obj_t * obj)
{
    lv_theme_t * th = lv_theme_get_from_obj(obj);
	if (th&&th->font_title)
		return th->font_title;
	else
		return LV_FONT_DEFAULT;
}

const lv_font_t * lv_theme_get_font_bigl(lv_obj_t * obj)
{
    lv_theme_t * th = lv_theme_get_from_obj(obj);
	if (th&&th->font_bigl)
		return th->font_bigl;
