...
#define AAC_MINI_STACK  1

#ifdef AAC_MINI_STACK
typedef struct {
    #ifdef DRM
    int16_t DRM_aac_scalable_main_element_spec_data1[1024];
    int16_t DRM_aac_scalable_main_element_spec_data2[1024];
    #endif
    real_t reconstruct_channel_pair_spec_coef1[1024];
    real_t reconstruct_channel_pair_spec_coef2[1024];
    real_t ifilter_bank_transf_buf[2 * 1024];
    int16_t channel_pair_element_spec_data1[1024];
    int16_t channel_pair_element_spec_data2[1024];
    element channel_pair_element_cpe;
    real_t reconstruct_single_channel_spec_coef[1024];
    int16_t single_lfe_channel_element_spec_data[1024];
    element  single_lfe_channel_element_sce;
    #ifdef COUPLING_DEC
    element coupling_channel_element_el_empty;
    ic_stream coupling_channel_element_ics_empty;
    int16_t coupling_channel_element_sh_data[1024];
    #endif
} stack_malloc_member;
#endif
