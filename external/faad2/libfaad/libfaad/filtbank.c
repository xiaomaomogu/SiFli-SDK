...
void ifilter_bank(NeAACDecStruct *hDecoder, uint8_t window_sequence, uint8_t window_shape,
                  ...
                  uint8_t object_type, uint16_t frame_len)
{
    ...
    real_t *transf_buf = &hDecoder->stack_mem.ifilter_bank_transf_buf[0];
    memset(transf_buf, 0, 2*1024 * sizeof(real_t));
#else
