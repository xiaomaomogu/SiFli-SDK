...
void avcodec_register_all(void)
{
    ...
    REGISTER_DECODER(MP3,               mp3);    //fix mp3 decoder
#endif
#if CONFIG_MP3FLOAT_DECODER
    REGISTER_DECODER(MP3FLOAT,          mp3float); //float mp3 decoder
#endif
...
#endif
    {
       extern AVCodec ff_ezip565_decoder;
       extern AVCodec ff_ezip888_decoder;
       avcodec_register(&ff_ezip565_decoder);
       avcodec_register(&ff_ezip888_decoder);
    }
#if CONFIG_H263_DECODER
    REGISTER_PARSER(H263,               h263);
    REGISTER_DECODER(H263,              h263);
#endif
#if CONFIG_VORBIS_DECODER && CONFIG_OGG_DECODER_SUPPORT
