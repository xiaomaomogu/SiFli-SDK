...
AVCodec ff_aac_decoder = {
    .name            = "aac",
    .long_name       = NULL, //NULL_IF_CONFIG_SMALL("AAC (Advanced Audio Coding)"),
...
AVCodec ff_aac_latm_decoder = {
    .name            = "aac_latm",
    .long_name       = NULL, //NULL_IF_CONFIG_SMALL("AAC LATM (Advanced Audio Coding LATM syntax)"),
    .type            = AVMEDIA_TYPE_AUDIO,
    ...
    .channel_layouts = aac_channel_layout,
    .flush = flush,
    .profiles        = NULL,//NULL_IF_CONFIG_SMALL(ff_aac_profiles),
};
