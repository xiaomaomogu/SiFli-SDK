...
INC += -I$(LVGL_BINDING_DIR) -I$(LVGL_DIR) -I $(LVGL_DIR)/src -I $(LVSF_DIR) -I. -I ../../../middleware/include/ -I ../../../middleware/lvgl/
ALL_LVGL_SRC = $(shell find $(LVGL_DIR) -type f -name '*.h')
#$(LVGL_BINDING_DIR)/lv_conf.h
LVGL_PP = $(BUILD)/lvgl/lvgl.pp.c
LVGL_MPY = $(BUILD)/lvgl/lvgl_v8_mpy.c
LVGL_MPY_METADATA = $(BUILD)/lvgl/lv_mpy.json
QSTR_GLOBAL_DEPENDENCIES += $(LVGL_MPY)
CFLAGS_MOD += $(LV_CFLAGS) 

#LVSF
LVSF_DIR = $(LVGL_BINDING_DIR)/lvsf
ALL_LVSF_SRC = $(shell find $(LVSF_DIR) -type f -name '*.h') 
#$(LVGL_BINDING_DIR)/lv_conf.h
LVSF_PP = $(BUILD)/lvsf/lvsf.pp.c
LVSF_MPY = $(BUILD)/lvsf/lvsf_v8_mpy.c
LVSF_MPY_METADATA = $(BUILD)/lvsf/lvsf_mpy.json
QSTR_GLOBAL_DEPENDENCIES += $(LVSF_MPY)

$(LVGL_MPY): $(ALL_LVGL_SRC) $(LVGL_BINDING_DIR)/gen/gen_mpy.py 
	$(ECHO) "LVGL-GEN $@"
	$(Q)mkdir -p $(dir $@)
	$(CPP) $(CFLAGS_MOD) -DPYCPARSER -DLV_CONF_INCLUDE_SIMPLE -DPY_GEN -x c \
		-I $(LVGL_BINDING_DIR)/pycparser/utils/fake_libc_include \
		$(INC) $(LVGL_DIR)/lvgl.h > $(LVGL_PP)
	$(Q)$(PYTHON) $(LVGL_BINDING_DIR)/gen/gen_mpy.py -M lvgl -MP lv -MD $(LVGL_MPY_METADATA) -E $(LVGL_PP) $(LVGL_DIR)/lvgl.h > $@

$(LVSF_MPY): $(ALL_LVSF_SRC) $(LVGL_BINDING_DIR)/gen/gen_mpy.py 
	$(ECHO) "LVSF-GEN $@"
	$(Q)mkdir -p $(dir $@)
	$(CPP) $(CFLAGS_MOD) -DPYCPARSER -DLV_CONF_INCLUDE_SIMPLE -DPY_GEN -x c \
		-I $(LVGL_BINDING_DIR)/pycparser/utils/fake_libc_include -I $(LVGL_DIR) -I $(LVGL_DIR)/src -I $(LVSF_DIR) -I ../../../middleware/include/ -I ../../../middleware/lvgl/ \
		$(INC) $(LVSF_DIR)/lvsf.h > $(LVSF_PP)
	$(Q)$(PYTHON) $(LVGL_BINDING_DIR)/gen/gen_mpy.py -M lvgl -MP lv -MD $(LVSF_MPY_METADATA) -E $(LVSF_PP) $(LVSF_DIR)/lvsf.h > $@
	cp $(LVSF_MPY) ../lvgl_v8_mpy.c
	
.PHONY: LVGL_MPY 
LVGL_MPY: $(LVSF_MPY)

sifli: $(HEADER_BUILD)/qstrdefs.generated.h $(LVSF_MPY)
	cp $(BUILD)/lvsf/lvsf_mpy.json ../../quickjs/script/lvsf_mpy.json
...
$(HEADER_BUILD)/qstrdefs.generated.h: $(PY_QSTR_DEFS) $(QSTR_DEFS) $(QSTR_DEFS_COLLECTED) $(PY_SRC)/makeqstrdata.py mpconfigport.h $(MPCONFIGPORT_MK) $(PY_SRC)/mpconfig.h | $(HEADER_BUILD)
	...
	cp $@ ../port/genhdr/qstrdefs.lvgl.h
	$(PYTHON) ../port/genhdr/rm_dup.py --src=../port/genhdr/qstrdefs.generated.h --dest=../port/genhdr/qstrdefs.lvgl.h
