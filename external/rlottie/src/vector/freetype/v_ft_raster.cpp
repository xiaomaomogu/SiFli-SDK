...
extern "C" void* app_anim_mem_alloc(unsigned int size, bool anim_data);
extern "C" void app_anim_mem_free(void* p);
                              ...
                              const SW_FT_Raster_Params* params)
{
    ...
    TCell * buffer = (TCell*)app_anim_mem_alloc(SW_FT_RENDER_POOL_SIZE,1);
    long  buffer_size = SW_FT_RENDER_POOL_SIZE;
