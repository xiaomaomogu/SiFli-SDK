...
set RELAY_PORT=COM3
set UART_BURN_DES=SIFLI_2C
set UART_H_DES=SIFLI_2D
set UART_L_DES=SIFLI_2C
set RTYPE=0
set RCHAN=4
set BCHAN=3
set DEVICE_TYPE=SF32LB56X_NAND
set PRJ_NAME=ec-lb563
set BSP_PRJ_H=test\drivers\project\ec-lb563\hcpu
::set BSP_PRJ_L=test\drivers\project\ec-lb563\lcpu
