...
set RELAY_PORT=COM3
set UART_BURN_DES=SIFLI_6B
set UART_H_DES=SIFLI_6B
set UART_L_DES=SIFLI_6B
set RTYPE=0
set RCHAN=6
set BCHAN=0
set DEVICE_TYPE=SF32LB52X_NAND
set PRJ_NAME=eh-lb525
set BSP_PRJ_H=test\drivers\project\52x_hdk\hcpu_525_nand
::set BSP_PRJ_L
