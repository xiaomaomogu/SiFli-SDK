...
set RELAY_PORT=COM3
set UART_BURN_DES=SIFLI_1C
set UART_H_DES=SIFLI_1D
set UART_L_DES=SIFLI_1C
set RTYPE=0
set RCHAN=14
set BCHAN=13
set DEVICE_TYPE=SF32LB56X_NOR
set PRJ_NAME=eh-lb561
set BSP_PRJ_H=test\drivers\project\eh-lb561\hcpu
::set BSP_PRJ_L=test\drivers\project\eh-lb561\lcpu
