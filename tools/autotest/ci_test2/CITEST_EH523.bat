...
set RELAY_PORT=COM3
set UART_BURN_DES=SIFLI_6A
set UART_H_DES=SIFLI_6A
set UART_L_DES=SIFLI_6A
set RTYPE=0
set RCHAN=5
set BCHAN=0
set DEVICE_TYPE=SF32LB52X_NOR
set PRJ_NAME=eh-lb523
set BSP_PRJ_H=test\drivers\project\52x_hdk\hcpu_523
::set BSP_PRJ_L
