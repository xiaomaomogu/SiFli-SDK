...
set RELAY_PORT=COM3
set UART_BURN_DES=SIFLI_1A
set UART_H_DES=SIFLI_1B
set UART_L_DES=SIFLI_1A
set RTYPE=0
set RCHAN=16
set BCHAN=15
set DEVICE_TYPE=SF32LB58X
set PRJ_NAME=ec-lb583
set BSP_PRJ_H=test\drivers\project\ec-lb58xxxxxx001\v11_583
::set BSP_PRJ_L=test\drivers\project\ec-lb58xxxxxx001\lcpu
