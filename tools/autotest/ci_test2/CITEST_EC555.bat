...
set RELAY_PORT=COM3
set UART_BURN_DES=SIFLI_2A
set UART_H_DES=SIFLI_2B
set UART_L_DES=SIFLI_2A
set RTYPE=0
set RCHAN=2
set BCHAN=1
set DEVICE_TYPE=SF32LB55X
set PRJ_NAME=ec-lb555
set BSP_PRJ_H=test\drivers\project\ec-lb555XXXX001_hcpu
set BSP_PRJ_L=test\drivers\project\ec-lb555XXXX001_lcpu_ram
