...
#include "dfu.h"
    ...
    #define FLASH_USER_CODE_START_ADDR 0x12020000

    #define FLASH_IMG_START_ADDR 0x12020000
#else
    #undef FLASH_USER_CODE_START_ADDR
    #define FLASH_USER_CODE_START_ADDR 0x10020000
    #define FLASH_IMG_START_ADDR       0x10020000
#endif
