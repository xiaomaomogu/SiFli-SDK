...
move ..\..\..\..\rom_bin\lcpu_general_ble_img\lcpu_img.c ..\..\..\..\rom_bin\lcpu_general_ble_img\lcpu_ss6600_a3.c 
copy build\keil\list\bf0_ap.map build
copy build\keil\Obj\bf0_ap.axf build
copy build\keil\Obj\bf0_ap.lst build
copy build\bf0_ap.axf ..\..\..\..\rom_bin\lcpu_general_ble_img\lcpu_general_6600_a3.axf