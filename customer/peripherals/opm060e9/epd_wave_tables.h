...
void epd_wave_table_convert_i4o2(uint8_t *output_pic_a2, const uint8_t *input_old_pic_a4, const uint8_t *input_new_pic_a2, uint32_t input_bytes, uint8_t frame);
